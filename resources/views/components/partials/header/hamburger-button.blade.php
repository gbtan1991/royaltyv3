 <button :class="sidebarToggle ? 'lg:bg-transparent dark:lg:bg-transparent bg-gray-100 dark:bg-gray-800' : ''"
     class="hidden lg:flex z-99999 items-center justify-center rounded-lg border-gray-200 text-gray-500 h-11 w-11 border dark:border-gray-800 dark:text-gray-400"
